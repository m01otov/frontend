...
export const SVGRuntimeEllipseRendarable = observer(forwardRef<SVGSVGElement, TRenderableProps>(({
  entity,
}, ref) => {
...
SVGRuntimeEllipseRendarable.displayName = 'SVGRuntimeEllipseRendarable';
