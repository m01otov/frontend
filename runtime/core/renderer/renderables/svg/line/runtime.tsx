...
export const SVGRuntimeLineRendarable = observer(forwardRef<SVGSVGElement, TRenderableProps>(({
  entity,
}, ref) => {
  ...
  const { loading, value } = useAsync(async () => {
    // TODO: get script content by id and load
...
SVGRuntimeLineRendarable.displayName = 'SVGRuntimeLineRendarable';
