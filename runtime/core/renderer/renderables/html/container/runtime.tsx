...
export const HTMLRuntimeContainerRendarable = observer(forwardRef<HTMLDivElement, TRenderableProps>(({
  entity,
}, ref) => {
...
HTMLRuntimeContainerRendarable.displayName = 'HTMLRuntimeContainerRendarable';
