...
export const HTMLRuntimeButtonRendarable = observer(forwardRef<HTMLButtonElement, TRenderableProps>(({
  entity,
}, ref) => {
...
HTMLRuntimeButtonRendarable.displayName = 'HTMLRuntimeButtonRendarable';
