...
type HTMLButtonRenderProps = TRenderableProps & {
  isLocked?: boolean;
}

export const HTMLButtonRender = observer(forwardRef<HTMLButtonElement, HTMLButtonRenderProps>(({
  entity,
  isLocked
}, ref) => {
  ...
  return (
    <button
      ref={ref}
      className={styles.html_button_renderable}
      style={style}
...
HTMLButtonRender.displayName = 'HTMLButtonRender';
