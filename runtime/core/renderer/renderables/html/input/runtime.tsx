...
export const HTMLRuntimeInputRendarable = observer(forwardRef<HTMLInputElement, TRenderableProps>(({
  entity,
}, ref) => {
...
HTMLRuntimeInputRendarable.displayName = 'HTMLRuntimeInputRendarable';
