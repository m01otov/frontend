...
export const HTMLRuntimeLableRendarable = observer(forwardRef<HTMLLabelElement, TRenderableProps>(({
  entity,
}, ref) => {
...
HTMLRuntimeLableRendarable.displayName = 'HTMLRuntimeLableRendarable';
