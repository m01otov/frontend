...
import { ellipseFactory } from '../../../factories';

import styles from './styles.module.scss';

type TDrawEllipseToolProps = {} & TToolBaseProps;

export const DrawEllipseTool: FC<TDrawEllipseToolProps> = ({
  target,
  onComplete
}) => {
  ...
  const { isDrag, rect } = useMouseDragRect(target, (rect: TRectangle) => {
    ...
    const entityComponentsData = ellipseFactory({
      parent: {
        id: null
      },
      transform: {
  ...
  return (
    <>
      <ToolFrame
        ...
        rect={rect}
        shouldRender={isDrag}>
        <div className={styles.draw_ellipse_tool__preview} />
      </ToolFrame>
...
DrawEllipseTool.displayName = 'DrawEllipseTool';
